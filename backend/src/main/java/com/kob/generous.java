...
//
//        new DataSourceConfig.Builder("jdbc:mysql://localhost:3306/kob","root","root")
//                .build();
//
//
//        //设置全局配置
...
////        globalConfig.setOutputDir("E:/miyan/spring/MybatisPlus/MybatisPlus_04_generator/src/main/java"); //设置代码生成位置
